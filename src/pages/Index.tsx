      ...
      <header className="sticky top-0 z-40 surface-glass px-5 py-4">
        <div className="container flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base font-bold text-foreground tracking-tight">FuelWatch PH</h1>
              <p className="text-xs text-muted-foreground">Real-time fuel tracking</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            {user ? (
              <button
                ...
                className="sovereign-ease transition-transform hover:scale-105"
              >
